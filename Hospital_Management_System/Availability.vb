...
Public Class Availability
    ...
    Private Sub SearchBtn_Click(sender As Object, e As EventArgs) Handles SearchBtn.Click
        close()
            If Designation = "" Then
            MessageBox.Show("обозначение щелчка")
            Exit Sub
            End If
            Try
    ...
    End Sub
    Private Sub NurseBtn1_CheckedChanged(sender As Object, e As EventArgs) Handles NurseBtn1.CheckedChanged
    ...
    Private Sub DataGridView1_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles SearchResultGrid.CellMouseClick
        ...
        Try
            ...
            End If
        Catch ex As Exception
            'MessageBox.Show("Выберите допустимую строку")
        End Try
    ...
    Private Sub colourgreen()
        ...
        ShowAvailability.Text = "Доступный"
    End Sub
    ' colour label red
    Private Sub colourred()
        ShowAvailability.BackColor = Color.Red
        ShowAvailability.Text = "Недоступный"
    End Sub
