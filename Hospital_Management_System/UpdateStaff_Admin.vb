...
Public Class UpdateStaff_Admin
    ...
    Private Sub SearchBtn_Click(sender As Object, e As EventArgs) Handles SearchBtn.Click
        ...
        If Not Form1.Name_Validation(NameSTxt.Text.ToLower) Then
            MessageBox.Show("Введите действительное имя")
            Exit Sub
        ElseIf Designation = "" Then
            MessageBox.Show("нажмите обозначение")
            Exit Sub
        End If
        Try
            ...
            If SearchResultGrid.RowCount = 1 Then
                MessageBox.Show("не найдено.", "Результат")
                myconnection.Close()
                Exit Sub
            End If
    ...
    Private Sub RadioButton2_CheckedChanged(sender As Object, e As EventArgs) Handles NurseBtn.CheckedChanged
        Designation = "Мед. Сестра"
    End Sub
    Private Sub Receptionistbtn_CheckedChanged(sender As Object, e As EventArgs) Handles Receptionistbtn.CheckedChanged
        Designation = "Регистратор"
    End Sub
    Private Sub RadioButton11_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton11.CheckedChanged
        Designation = "Мед. Брат"
    End Sub
    ...
    Private Sub DataGridView1_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles SearchResultGrid.CellMouseClick
        ...
        Try
            ...
            AddressTxt.Text = row.Cells(7).Value.ToString
    ...
    Private Sub UpadateBtn_Click(sender As Object, e As EventArgs) Handles UpdateBtn.Click
        ...
        str = "Update [Staff] set [Date Of Birth] = #" & var_date & "#, [Mobile]='" & MobileTxt.Text & "',[Work Shift]='" & WorkShiftTxt.Text & "',[Email]='" & EmailTxt.Text & "',[Address]='" & AddressTxt.Text & "'where [SID] = " & SIDTxt.Text & " "
        ' mobile validation
