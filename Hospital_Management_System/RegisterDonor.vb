...
Class RegisterDonor
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles AddBtn.Click
        ...
        Try
            ...
            cmd.Parameters.Add(New OleDbParameter("Name", NameTxt.Text))
            ...
            SuccessMsg.Text = "Донор успешно зарегистрирован !!"
    ...
    Private Function Validate_data() As Boolean
        ...
        If Not Form1.age_validator(AgeTxt.Text) Then
            'Display failure Message
            SuccessMsg.Visible = True
            SuccessMsg.Text = "Недопустимый возраст"
            SuccessMsg.BackColor = Color.Red
            'Start timer
            Timer1.Start()
            Return False
        ...
        ElseIf Integer.TryParse(AgeTxt.Text, temp) And (temp < 18 Or temp > 55) Then
            'Display failure Message
            SuccessMsg.Visible = True
            SuccessMsg.Text = "Донор, не имеющий на это права"
            SuccessMsg.BackColor = Color.Red
            'Start timer
            Timer1.Start()
            Return False
        ...
        If BloodGrpTxt.SelectedIndex = 0 Then
            'Display failure Message
            SuccessMsg.Visible = True
            SuccessMsg.Text = "Выберите правильную группу крови"
            SuccessMsg.BackColor = Color.Red
            'Start timer
            Timer1.Start()
            Return False
        ...
        If Not Form1.Decimal_Validator(QuantityTxt.Text) Then
            'Display failure Message
            SuccessMsg.Visible = True
            SuccessMsg.Text = "Недопустимое количество"
            SuccessMsg.BackColor = Color.Red
            'Start Timer
            Timer1.Start()
            Return False
